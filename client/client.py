...
class ClientGUI:
    def __init__(self, root):
        ...
        self.host = '127.0.0.1'
        self.port = 8001
        self.server_public_key = None # Sunucudan gelecek public key için
            ...
            if method == "substitution":
                ...
                try:
                    ...
                    if len(matrix_values) == 4:
                        key_matrix = [[matrix_values[0], matrix_values[1]], [matrix_values[2], matrix_values[3]]]
    ...
    def connect_to_server(self):
        ...
        def connect():
            try:
                # --- DÜZELTME: Soket nesnesini burada oluşturuyoruz ---
        ...
        try:
            while self.connected:
                ...
                try:
                    ...
                    # Decryption için kütüphane modu kontrolü
    ...
    def send_message(self, event=None):
        ...
        try:
            ...
            if self.current_encryption in ["aes", "des"] and hasattr(self, 'server_public_key') and self.server_public_key:
